...
if (data_version == 1) {
  ...
  kin_col <- c("index","state","x","y","vx","vy","fs_x","fs_y","time_trial","time_global","unused3","unused4") # columns of kinematic data. changed in version 11 of labview program
  
} else {
  kin_col <- c("index","state","x","y","vx","vy","fs_x","fs_y","time_global","unused2","unused3","unused4") # columns of kinematic data. changed in version 11 of labview program
